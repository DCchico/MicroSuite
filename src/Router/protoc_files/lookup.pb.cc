...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_lookup_2eproto = {
  false, false, descriptor_table_protodef_lookup_2eproto, "lookup.proto", 801,
...
static bool dynamic_init_dummy_lookup_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_lookup_2eproto)), true);
namespace lookup {
