...
extern PROTOBUF_INTERNAL_EXPORT_router_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Util_router_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_router_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_UtilRequest_router_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_router_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_UtilResponse_router_2eproto;
namespace router {
...
class RouterRequestDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<RouterRequest> _instance;
} _RouterRequest_default_instance_;
class UtilDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<Util> _instance;
...
static void InitDefaultsscc_info_LookupResponse_router_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::router::_LookupResponse_default_instance_;
    new (ptr) ::router::LookupResponse();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::router::LookupResponse::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_LookupResponse_router_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_LookupResponse_router_2eproto}, {
      &scc_info_UtilResponse_router_2eproto.base,}};

static void InitDefaultsscc_info_RouterRequest_router_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::router::_RouterRequest_default_instance_;
    new (ptr) ::router::RouterRequest();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::router::RouterRequest::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_RouterRequest_router_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_RouterRequest_router_2eproto}, {
      &scc_info_UtilRequest_router_2eproto.base,}};

static void InitDefaultsscc_info_Util_router_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::router::_Util_default_instance_;
    new (ptr) ::router::Util();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::router::Util::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Util_router_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_Util_router_2eproto}, {}};

static void InitDefaultsscc_info_UtilRequest_router_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::router::_UtilRequest_default_instance_;
    new (ptr) ::router::UtilRequest();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::router::UtilRequest::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_UtilRequest_router_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_UtilRequest_router_2eproto}, {}};

static void InitDefaultsscc_info_UtilResponse_router_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::router::_UtilResponse_default_instance_;
    new (ptr) ::router::UtilResponse();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::router::UtilResponse::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_UtilResponse_router_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_UtilResponse_router_2eproto}, {
      &scc_info_Util_router_2eproto.base,}};
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_router_2eproto_sccs[5] = {
  &scc_info_LookupResponse_router_2eproto.base,
  &scc_info_RouterRequest_router_2eproto.base,
  &scc_info_Util_router_2eproto.base,
  &scc_info_UtilRequest_router_2eproto.base,
  &scc_info_UtilResponse_router_2eproto.base,
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_router_2eproto = {
  false, false, descriptor_table_protodef_router_2eproto, "router.proto", 1216,
  &descriptor_table_router_2eproto_once, descriptor_table_router_2eproto_sccs, descriptor_table_router_2eproto_deps, 5, 1,
...
const UtilRequest& UtilRequest::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_UtilRequest_router_2eproto.base);
...
void RouterRequest::InitAsDefaultInstance() {
  ::router::_RouterRequest_default_instance_._instance.get_mutable()->util_request_ = const_cast< ::router::UtilRequest*>(
...
void RouterRequest::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_RouterRequest_router_2eproto.base);
  key_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  value_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
void Util::InitAsDefaultInstance() {
}
...
const Util& Util::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_Util_router_2eproto.base);
  return *internal_default_instance();
}
...
void UtilResponse::InitAsDefaultInstance() {
  ::router::_UtilResponse_default_instance_._instance.get_mutable()->router_util_ = const_cast< ::router::Util*>(
...
void UtilResponse::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_UtilResponse_router_2eproto.base);
  ::memset(&router_util_, 0, static_cast<size_t>(
...
void LookupResponse::InitAsDefaultInstance() {
  ::router::_LookupResponse_default_instance_._instance.get_mutable()->util_response_ = const_cast< ::router::UtilResponse*>(
...
void LookupResponse::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_LookupResponse_router_2eproto.base);
  value_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  ::memset(&util_response_, 0, static_cast<size_t>(
